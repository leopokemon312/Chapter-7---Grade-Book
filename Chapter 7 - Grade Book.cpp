// Chapter 7 - Grade Book.cpp 
// This program calculates the average test score for five students and assigns a letter grade.
...
int main() {
    ...
    // Process: Calculate average scores and determine letter grades
    for (int i = 0; i < NUM_STUDENTS; i++) {
        double sum = 0;
        for (int j = 0; j < NUM_TESTS; j++) {
            sum += scores[i][j];
